...
<body>
 ...
 %> <a
						href="<%=request.getContextPath()%>/Boards/Admin/BoardList.bo?page=<%=nowpage - 1%>">[이전]</a>&nbsp; <%
 	}
 %> <%
 ...
 %> <a
						href="<%=request.getContextPath()%>/Boards/Admin/BoardList.bo?page=<%=a%>">[<%=a%>]
					</a>&nbsp; <%
 	}
 %> <%
 	}
 ...
 %> <a 
						href="<%=request.getContextPath()%>/Boards/Admin/BoardList.bo?page=<%=nowpage + 1%>">[다음]</a> <%
 	}
 %>
					</td>
				</tr>
